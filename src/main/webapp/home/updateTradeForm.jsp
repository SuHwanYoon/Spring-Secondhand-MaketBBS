...
<body>
<div align="center">
<form:form action="../read/updateTradeDo.html" method="post" encType="multipart/form-data"
		onSubmit="return check(this)" modelAttribute="tradeBBS">
<form:hidden path="writing_id" value="${tradeBBS.writing_id }"/>
<table width="100%">
	<tr><th>제 목</th><td><form:input path="title" size="20"
			value="${tradeBBS.title }"/></td></tr>
	<tr><th>가격</th><td><form:input path="price" size="20"
			value="${tradeBBS.price }"/>원</td></tr>
	<tr><th>암 호</th><td><form:password path="password" size="20"/>
		</td></tr>
	<tr><th>이미지</th><td><input type="file" name="IMAGENAME"/><br/>
		<img alt="" src="${pageContext.request.contextPath }/upload/${tradeBBS.image_name }" 
				width="350" height="300"></td></tr>
	<tr><th>글내용</th><td><form:textarea rows="8" cols="40"
		path="content" value="${tradeBBS.content }"></form:textarea></td></tr>
